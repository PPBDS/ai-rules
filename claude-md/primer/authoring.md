...
> **Primer tutorials follow the base tutorial guide (`claude-md/tutorials/CLAUDE.md`) by default; this file only adds Primer specifics or records explicit overrides.**
