...
| [`claude-md/vscode/CLAUDE.md`](claude-md/vscode/CLAUDE.md) | [vscode.tutorials](https://github.com/PPBDS/vscode.tutorials) | The infrastructure / mechanics package — the first tutorials students do, which teach the tools the base guide *assumes* (Git, GitHub, Codespaces, Quarto, terminals, CP/CR). It is the **exception** the base guide does not govern. Currently also houses the generic infrastructure knowledge drops salvaged from the normal tutorials, to be integrated properly later. |
